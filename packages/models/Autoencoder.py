...
class Conv3DAutoencoder(nn.Module):
    def __init__(self, in_channels=50, embedding_dim=128):
        ...
        self.decoder = nn.Sequential(
            ...
            nn.ConvTranspose3d(256, 128, kernel_size=3, stride=2, padding=1, output_padding=(1, 0, 0)),
            nn.BatchNorm3d(128),
            nn.ReLU(),
            
            nn.ConvTranspose3d(128, 64, kernel_size=3, stride=2, padding=1, output_padding=(0, 0, 1)),
            nn.BatchNorm3d(64),
            nn.ReLU(),
