...
class Dataset(Dataset):
    def __init__(self, root_folder: str, unpack_func: Union[Callable[[Any], Any], str] = None, file_type: str = 'npz'):
    ...
    def _gather_files(self):
        ...
        subdirs = any(os.path.isdir(os.path.join(self.root_folder, item)) 
    ...
    @classmethod
    def get_test_dataset(cls, root_folder: str, nsamples = 1, unpack_func: Union[Callable[[Any], Any], str] = None, file_type: str = 'npz'):
        instance = cls(root_folder=root_folder, unpack_func=unpack_func, file_type=file_type)
